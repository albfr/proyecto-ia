...
/*:7*/
#line 88 "original_xcc.w"
;
/*3:*/
#line 165 "original_xcc.w"
...
/*:24*/
#line 89 "original_xcc.w"
;
/*10:*/
#line 321 "original_xcc.w"
...
#line 380 "original_xcc.w"
        ...
        /*:13*/
#line 376 "original_xcc.w"
        ;
    }
}

/*:12*//*26:*/
#line 623 "original_xcc.w"
...
#line 193 "original_xcc.w"
    ...
    if(randomizing)srand(time(NULL));

    /*:4*/
#line 93 "original_xcc.w"
    ;
    /*14:*/
#line 394 "original_xcc.w"
...
#line 416 "original_xcc.w"
    ...
    /*:14*/
#line 94 "original_xcc.w"
    ;
    /*17:*/
#line 446 "original_xcc.w"
...
#line 509 "original_xcc.w"
            ...
            /*:19*/
#line 496 "original_xcc.w"
            ;

            /*:18*/
#line 460 "original_xcc.w"
            ;
...
#line 474 "original_xcc.w"
    ...
    /*:17*/
#line 95 "original_xcc.w"
    ;
    if(vbose&show_basics)
        /*21:*/
#line 528 "original_xcc.w"
    ...
    /*:21*/
#line 97 "original_xcc.w"
    ;
    if(vbose&show_tots)
        /*22:*/
#line 537 "original_xcc.w"
    ...
    /*:22*/
#line 99 "original_xcc.w"
    ;
    imems= mems,mems= 0;
    /*23:*/
#line 564 "original_xcc.w"
...
#line 600 "original_xcc.w"
        ...
        /*:25*/
#line 569 "original_xcc.w"
        ;
        /*32:*/
#line 770 "original_xcc.w"
        ...
        for(o,k= cl[root].next;t&&k!=root;o,k= cl[k].next){
            ...
            if(o,nd[k].len<=t){
                if(nd[k].len<t)best_itm= k,t= nd[k].len,p= 1;
                    ...
                    p++;
                    if(randomizing&&(mems+= 4,rand() % p == 0))best_itm= k;
                }
            }
        }
        if((vbose&show_details)&&
...
#line 678 "original_xcc.w"
        ...
        /*:28*/
#line 578 "original_xcc.w"
        ;
        if(o,cl[root].next==root)/*33:*/
#line 796 "original_xcc.w"
...
#line 813 "original_xcc.w"
            ...
            /*:34*/
#line 810 "original_xcc.w"
            ;
        }

        /*:33*/
#line 579 "original_xcc.w"
        ;
        if(++level> maxl){
            if(level>=max_level){
                fprintf(stderr,"Too many levels!\n");
...
#line 537 "original_xcc.w"
     ...
     /*:22*/
#line 104 "original_xcc.w"
     ;
     if(vbose&show_profile)/*37:*/
#line 877 "original_xcc.w"
...
#line 105 "original_xcc.w"
     ...
     /*5:*/
#line 219 "original_xcc.w"

     if(shape_file)fclose(shape_file);

     /*:5*/
#line 117 "original_xcc.w"
     ;
}
